    ...
    public UpdateAppBean fillUpdateAppData() {
        if (mUpdateApp != null) {
            if (mHttpManager == null) {
                mHttpManager = new DefaultHttpUtil();
            }
...
//                || !mTargetPath.startsWith(preSuffix)
        ...
        Log.e(TAG, "verify: " + (mUpdateApp == null));
...
//            bundle.putParcelable(INTENT_KEY,mUpdateApp);
     ...
     * 自定义填充返回参数
     * @param update 是否需要更新
     * @param new_version_name 更新版本号
     * @param apkUrl 下载地址
     * @param details 更新详情
     * @param isForce 是否强制更新
     */
    public void update(boolean update, String new_version_name, String apkUrl, String details, boolean isForce) {
